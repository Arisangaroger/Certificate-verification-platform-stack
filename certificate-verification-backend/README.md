...
Interactive Swagger documentation is available at **`/api/docs`** when the server is running (e.g. `http://localhost:3000/api/docs`). Use **Authorize** with a JWT from admin login or student OTP verification to test protected routes.
